...
public abstract class PlayerBase extends Vault {
	...
	// operations
	public abstract void sendChallenge(String requesterPublicKey, String requestToken, Match match) throws Exception;
	public abstract void acceptChallenge(String requesterPublicKey, String requestToken, String matchId, boolean response) throws Exception;
